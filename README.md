...
However, if a user ever clears the Fly Images folder, these images will be deleted and then never resized again unless the user goes and edits the block. (i.e. All images will 404!) :weary:
